                ...
                <div class="card-body">
                    <form name="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return checkValidates()" method="post">  
                                ...
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <input class="input--style-5 " placeholder="Last Name" type="text" name="family_name">
                                            
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="input-group-desc">
                                            <input class="input--style-5 " placeholder="First Name" type="text" name="first_name">
                                    
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" placeholder="Middle Name" type="text" name="middle_name">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input  class="input--style-5" placeholder="Alias" type="text" name="alias">
                                </div>
                            </div>
                        </div>
                        <!-- FACE MARKS-->
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" placeholder="Face Marks" type="text" name="face_marks">
                                </div>
                            </div>
                        </div>
                        <!-- BIRTHDAY || BIRTHPLACE -->
                            ...
                            <div class="name">Birthday</div>
                              <div class="value">
                                <div class="row row-space">
                                    <div class="col-1">
                                        <div class="input-group">
                                         <input class="input--style-5" style="height: 35px; width: 170px;" placeholder="Birthday" type="date" name="birth_date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="name" style="margin-top: 5px; margin-right: 0px;">Birthplace</div>
                                       <div class="col-1">
                                          <div class="input-group">
                                            <input class="input--style-5" placeholder="Birthplace" type="text" name="birth_place">
                                           </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Nationality" type="text" name="nationality">
                                </div>
                            </div>
                        </div>
                        <!-- RELIGION-->
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Religion" type="text" name="religion">
                                </div>
                            </div>
                        </div>
                        <!-- OCCUPATION || SECTOR-->
                        <div class="form-row">
                            <div class="name">Occupation</div>
                              <div class="value">
                                <div class="row row-space">
                                    <div class="col-1">
                                        <div class="input-group" style="padding-left: 15px;">
                                         <input class="input--style-5" style="height: 35px; width: 170px;" placeholder="Occupation" type="text" name="occupation">
                                        </div>
                                    </div>
                            ...
                            <div class="name">Spouse's Name</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Spouse's Name" type="text" name="spouse_name">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="name">Spouse's Occupation</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Spouse's Occupation" type="text" name="spouse_occupation">
                                </div>
                              </div>
                            </div>
                            <!-- VOTER STATUS-->
                          ...
                          <div class="form-row">
                            <div class="name">City Address</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="City Address" type="text" name="city_address">
                                </div>
                              </div>
                            </div>
                          <!-- PROVINCIAL ADDRESS-->
                          <div class="form-row">
                            <div class="name">Provincial Address</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Provincial Address" type="text" name="prov_address">
                                </div>
                              </div>
                            </div>
                          <!-- PUROK-->
                          <div class="form-row">
                            <div class="name">Purok</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="Purok" type="text" name="purok">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="name">Home Number</div>
                              <div class="value">
                                <div class="row row-space">
                                    <div class="col-1">
                                        <div class="input-group" style="padding-left: 15px;">
                                         <input class="input--style-5" pattern="[0-9]+" minlength="11" maxlength="11" style="height: 35px; width: 220px;" placeholder="Home Number 1" type="numbers" name="home_numone">
                                        </div>
                                    </div>                                 
                                     <div class="col-1">
                                          <div class="input-group">
                            ...
                            <div class="name">Mobile Number</div>
                              <div class="value">
                                <div class="row row-space">
                                    <div class="col-1">
                                        <div class="input-group" style="padding-left: 15px;">
                                         <input class="input--style-5" pattern="[0-9]+" minlength="11" maxlength="11" style="height: 35px; width: 220px;" placeholder="Mobile Number 1" type="numbers" name="mob_numone">
                                        </div>
                                    </div>                                 
                                     <div class="col-1">
                                          <div class="input-group">
                          ...
                          <div class="form-row">
                            <div class="name">E-mail</div>
                              <div class="value">
                                <div class="input-group" style="padding-left: 15px;">
                                    <input  class="input--style-5" placeholder="E-mail" type="text" name="email">
                                </div>
                              </div>
                            </div>
